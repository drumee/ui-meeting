...
export default class MucConnectionPlugin extends ConnectionPluginListenable {
    ...
    init(connection) {
        ...
        this.connection.addHandler(this.onMuteDesktop.bind(this), 'http://jitsi.org/jitmeet/desktop', 'iq', 'set', null, null);
    ...
    onVisitors(iq) {
        ...
        if (visitors && response) {
            if (String(getAttribute(response, 'allow')).toLowerCase() === 'true') {
                ...
                this.xmpp.eventEmitter.emit(CONNECTION_REDIRECTED, undefined, getAttribute(visitors, 'focusjid'), getAttribute(response, 'username'));
            }
            else {
