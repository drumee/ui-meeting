...
export class QualityController {
    ...
    constructor(conference, options) {
        ...
        this._conference.on(JitsiConferenceEvents.INBOUND_VIDEO_STATS_RECEIVED, (tpc, stats) => this._processInboundVideoStats(tpc, stats));
    }
    /**
     ...
     * @returns {void}
     */
    _processInboundVideoStats(tpc, stats) {
