...
class ScreenObtainer {
    ...
    _getAudioConstraints() {
        ...
        let audio = (audioQuality?.stereo || needsEchoCancellation)
     ...
     */
    _obtainScreenOnElectron(onSuccess, onFailure, options = {}) {
     ...
     * @param {Object} options - Optional parameters.
     */
    _obtainScreenFromGetDisplayMedia(callback, errorCallback, options = {}) {
        let getDisplayMedia;
        ...
        const { desktopSharingFrameRate = this.options?.desktopSharingFrameRate, resolution = this.options?.resolution, screenShareSettings = this.options?.screenShareSettings } = options;
