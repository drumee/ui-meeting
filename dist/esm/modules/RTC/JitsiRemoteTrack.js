...
export default class JitsiRemoteTrack extends JitsiTrack {
    ...
    _playCallback() {
        ...
        const gumDuration = isValidNumber(gumEnd) && isValidNumber(gumStart) ? gumEnd - gumStart : 0;
    ...
    _initTrackStreamingStatus() {
        ...
        this._trackStreamingStatusImpl = new TrackStreamingStatusImpl(this._rtc, this.conference, this, {
        ...
        !this._trackStreamingStatusImpl.isVideoTrackFrozen()
            && this._rtc.eventEmitter.emit(JitsiTrackEvents.TRACK_STREAMING_STATUS_CHANGED, this, this._trackStreamingStatus);
    }
    /**
